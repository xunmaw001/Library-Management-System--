 ...
 */
@RestController
@RequestMapping("/cuihaitixing")
public class CuihaitixingController {
    @Autowired
    private CuihaitixingService cuihaitixingService;
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,CuihaitixingEntity cuihaitixing, 
		HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			cuihaitixing.setZhanghao((String)request.getSession().getAttribute("username"));
		}
        EntityWrapper<CuihaitixingEntity> ew = new EntityWrapper<CuihaitixingEntity>();


		PageUtils page = cuihaitixingService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, cuihaitixing), params), params));
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,CuihaitixingEntity cuihaitixing, 
		HttpServletRequest request){
    ...
    public R list( CuihaitixingEntity cuihaitixing){
       	EntityWrapper<CuihaitixingEntity> ew = new EntityWrapper<CuihaitixingEntity>();
      	ew.allEq(MPUtil.allEQMapPre( cuihaitixing, "cuihaitixing")); 
        return R.ok().put("data", cuihaitixingService.selectListView(ew));
    }
    ...
    @Transactional
    public R update(@RequestBody CuihaitixingEntity cuihaitixing, HttpServletRequest request){
        //ValidatorUtils.validateEntity(cuihaitixing);
        cuihaitixingService.updateById(cuihaitixing);//全部更新
        return R.ok();
    }
    ...
    public R delete(@RequestBody Long[] ids){
        cuihaitixingService.deleteBatchIds(Arrays.asList(ids));
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<CuihaitixingEntity> wrapper = new EntityWrapper<CuihaitixingEntity>();
		if(map.get("remindstart")!=null) {
