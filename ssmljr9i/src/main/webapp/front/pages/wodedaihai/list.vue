		...
		<view :style='{"width":"100%","padding":"0","position":"relative","background":"#fff","height":"100%"}'>
			<view class="cu-bar bg-white search" style="width:100%" :style="[{top:CustomBar + 'px'}]">
				<picker v-if="queryList.length>1" mode="selector" :range="queryList" range-key="queryName" :value="queryIndex" @change="queryChange" style="padding-left: 20upx;">
					...
					<view v-if="queryIndex==0" class="search-form round">
						...
						<input v-model="searchForm.jieyuebianhao" type="text" placeholder="借阅编号" ></input>
					</view>
			...
			<view class="list-box6" :style='{"padding":"0","margin":"0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
				...
				<view @tap="onDetailTap(product)" v-if="index%6==0" class="list-item" :style='{"width":"100%","margin":"0 0 20rpx","position":"relative","height":"auto"}'>
				  <image :style='{"width":"100%","padding":"0","margin":"0","objectFit":"cover","display":"block","height":"300rpx"}' mode="aspectFill" v-if="product.fengmian.substr(0,4)=='http'" :src="product.fengmian"></image>
				  <image :style='{"width":"100%","padding":"0","margin":"0","objectFit":"cover","display":"block","height":"300rpx"}' mode="aspectFill" v-else :src="product.fengmian?baseUrl+product.fengmian.split(',')[0]:''"></image>
				  <view :style='{"padding":"0","margin":"0 auto","color":"#666","top":"240rpx","textAlign":"center","left":"10%","background":"#fff","width":"80%","lineHeight":"44rpx","fontSize":"36rpx","position":"absolute","height":"88rpx"}' class="title">{{product.tushumingcheng}}</view>
				  <view :style='{"width":"100%","padding":"8rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
				  	<view :style='{"display":"flex","zIndex":"1111"}' v-if="(userid && isAuth('wodedaihai','修改')) || (!userid && isAuthFront('wodedaihai','修改'))" @click.stop="onUpdateTap(product.id)">
				  	...
				  	<view :style='{"display":"flex","zIndex":"111111"}' v-if="(userid && isAuth('wodedaihai','删除')) || (!userid && isAuthFront('wodedaihai','删除'))" @click.stop="onDeleteTap(product.id)">
				...
				<view @tap="onDetailTap(product)" v-if="index%6==1" class="list-item" :style='{"width":"48%","boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","margin":"20rpx","backgroundColor":"rgb(190, 176, 167)","flex":"1","height":"auto"}'>
				  <image :style='{"width":"100%","padding":"0","margin":"0","objectFit":"cover","display":"block","height":"300rpx"}' mode="aspectFill" v-if="product.fengmian.substr(0,4)=='http'" :src="product.fengmian"></image>
				  <image :style='{"width":"100%","padding":"0","margin":"0","objectFit":"cover","display":"block","height":"300rpx"}' mode="aspectFill" v-else :src="product.fengmian?baseUrl+product.fengmian.split(',')[0]:''"></image>
				  <view :style='{"width":"100%","padding":"4rpx 20rpx","lineHeight":"1.4","fontSize":"28rpx","color":"#666"}' class="title">{{product.tushumingcheng}}</view>
				  <view :style='{"width":"100%","padding":"8rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
				  	<view :style='{"display":"flex","zIndex":"1111"}' v-if="(userid && isAuth('wodedaihai','修改')) || (!userid && isAuthFront('wodedaihai','修改'))" @click.stop="onUpdateTap(product.id)">
				  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#000","display":"inline-block"}' class="cuIcon-edit"></text>
				  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#000","display":"inline-block"}'>修改</text>
				...
				<view @tap="onDetailTap(product)" v-if="index%6==3" class="list-item" :style='{"width":"100%","margin":"0 0 20rpx","backgroundColor":"#fff","position":"relative","height":"360rpx"}'>
				  <image :style='{"width":"100%","padding":"0","margin":"0","objectFit":"cover","display":"block","height":"300rpx"}' mode="aspectFill" v-if="product.fengmian.substr(0,4)=='http'" :src="product.fengmian"></image>
				  <image :style='{"width":"100%","padding":"0","margin":"0","objectFit":"cover","display":"block","height":"300rpx"}' mode="aspectFill" v-else :src="product.fengmian?baseUrl+product.fengmian.split(',')[0]:''"></image>
				  <view :style='{"padding":"4rpx 20rpx","color":"#666","top":"240rpx","left":"10%","textAlign":"center","background":"#fff","width":"80%","lineHeight":"44rpx","fontSize":"32rpx","position":"absolute","height":"88rpx"}' class="title">{{product.tushumingcheng}}</view>
				  <view :style='{"width":"100%","padding":"8rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
				  	<view :style='{"display":"flex","zIndex":"1111"}' v-if="(userid && isAuth('wodedaihai','修改')) || (!userid && isAuthFront('wodedaihai','修改'))" @click.stop="onUpdateTap(product.id)">
				  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#000","display":"inline-block"}' class="cuIcon-edit"></text>
				  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#000","display":"inline-block"}'>修改</text>
				...
				<view @tap="onDetailTap(product)" v-if="index%6==4" class="list-item" :style='{"boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","margin":"0 0 20rpx","flexWrap":"wrap","background":"rgb(190, 176, 167)","display":"flex","width":"48%","height":"auto"}'>
				  <image :style='{"width":"100%","objectFit":"cover","display":"block","height":"200rpx"}' mode="aspectFill" v-if="product.fengmian.substr(0,4)=='http'" :src="product.fengmian"></image>
				  <image :style='{"width":"100%","objectFit":"cover","display":"block","height":"200rpx"}' mode="aspectFill" v-else :src="product.fengmian?baseUrl+product.fengmian.split(',')[0]:''"></image>
				  <view class="list-item-body" :style='{"width":"100%","padding":"0","margin":"0","height":"auto"}'>
					<view :style='{"width":"100%","padding":"0 20rpx","margin":"0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333"}' class="title">{{product.tushumingcheng}}</view>
				  </view>
				  <view :style='{"width":"100%","padding":"8rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
				  	<view :style='{"display":"flex","zIndex":"1111"}' v-if="(userid && isAuth('wodedaihai','修改')) || (!userid && isAuthFront('wodedaihai','修改'))" @click.stop="onUpdateTap(product.id)">
				  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#000","display":"inline-block"}' class="cuIcon-edit"></text>
	...
	export default {
		...
		methods: {
			...
			async upCallback(mescroll) {
				...
				if(this.searchForm.jieyuebianhao){
                ...
                let res = {}
                if(this.userid) {
                    res = await this.$api.page(`wodedaihai`, params);
                } else {
                    params['sfsh'] = '是';
                    res = await this.$api.list(`wodedaihai`, params);
                }
				// 如果是第一页数据置空
			...
			onDeleteTap(id){
				...
				uni.showModal({
					...
					success: async function(res) {
						if (res.confirm) {
							await _this.$api.del('wodedaihai', JSON.stringify([id]));
							_this.hasNext = true
							// 重置分页参数页数为1
			...
			async search(){
				...
				if(this.searchForm.jieyuebianhao){
					searchForm['jieyuebianhao'] = '%' + this.searchForm.jieyuebianhao + '%'
				}
				if(this.searchForm.tushumingcheng){
                ...
                let res = {};
                if(this.userid) {
                    res = await this.$api.page(`wodedaihai`, searchForm);
                } else {
                    res = await this.$api.list(`wodedaihai`, searchForm);
                }
				// 如果是第一页数据置空
