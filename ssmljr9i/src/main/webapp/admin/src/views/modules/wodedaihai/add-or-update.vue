<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'" label="借阅编号" prop="jieyuebianhao">
					<el-input v-model="ruleForm.jieyuebianhao" placeholder="借阅编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.jieyuebianhao" label="借阅编号" prop="jieyuebianhao">
					<el-input v-model="ruleForm.jieyuebianhao" placeholder="借阅编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="图书编号" prop="tushubianhao">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="图书分类" prop="tushufenlei">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="借阅日期" prop="jieyueriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.jieyueriqi" label="借阅日期" prop="jieyueriqi">
					<el-input v-model="ruleForm.jieyueriqi" placeholder="借阅日期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="借阅天数" prop="jieyuetianshu">
					<el-input v-model="ruleForm.jieyuetianshu" placeholder="借阅天数" clearable  :readonly="ro.jieyuetianshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="借阅天数" prop="jieyuetianshu">
					<el-input v-model="ruleForm.jieyuetianshu" placeholder="借阅天数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="应还日期" prop="yinghairiqi">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.yinghairiqi" label="应还日期" prop="yinghairiqi">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `wodedaihai/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.wodedaihaiCrossAddOrUpdateFlag = false;
						 this.parent.search();
