		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"95%","margin":"0 0 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"display":"block"}' >
					<div :style='{"margin":"0 15px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"600","height":"40px"}' class="item-label">借阅编号</label>
				...
				<el-row :style='{"margin":"20px 0","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"rgba(255, 197, 35, 1)","borderRadius":"40px","background":"rgba(90, 67, 74, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('wodedaihai','新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"rgba(255, 197, 35, 1)","borderRadius":"40px","background":"rgba(90, 67, 74, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('wodedaihai','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='false' v-if="isAuth('wodedaihai','审核')" prop="sfsh" label="审核">
						<template slot-scope="scope">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"1px solid #5A434A","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#5A434A","borderRadius":"4px","background":"rgba(255, 255, 255, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('wodedaihai','查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"1px solid #5A434A","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#5A434A","borderRadius":"4px","background":"rgba(255, 255, 255, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('wodedaihai','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>





							<el-button :style='{"border":"1px solid #5A434A","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#5A434A","borderRadius":"4px","background":"rgba(255, 255, 255, 1)","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('wodedaihai','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
